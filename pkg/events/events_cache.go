...
func getSpamKey(event *corev1.Event) string {
	return strings.Join([]string{
		event.Source.Component,
		event.Source.Host,
		event.InvolvedObject.Kind,
...
type EventSpamKeyFunc func(event *corev1.Event) string
...
func (f *EventSourceObjectSpamFilter) Filter(event *corev1.Event) bool {
...
type EventAggregatorKeyFunc func(event *corev1.Event) (aggregateKey string, localKey string)
...
func EventAggregatorByReasonFunc(event *corev1.Event) (string, string) {
	return strings.Join([]string{
		event.Source.Component,
		event.Source.Host,
		event.InvolvedObject.Kind,
...
type EventAggregatorMessageFunc func(event *corev1.Event) string

// EventAggregatorByReasonMessageFunc returns an aggregate message by prefixing the incoming message
func EventAggregatorByReasonMessageFunc(event *corev1.Event) string {
...
func (e *EventAggregator) EventAggregate(newEvent *corev1.Event) (*corev1.Event, string) {
...
func (e *eventLogger) eventObserve(newEvent *corev1.Event, key string) (*corev1.Event, []byte, error) {
	var (
		patch []byte
		err   error
	)
...
func (e *eventLogger) updateState(event *corev1.Event) {
...
func (c *EventCorrelator) EventCorrelate(newEvent *corev1.Event) (*EventCorrelateResult, error) {
	if newEvent == nil {
...
func (c *EventCorrelator) UpdateState(event *corev1.Event) {
